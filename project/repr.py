...
class RePR:
    def __init__(self, mode='stm', batch_size=32, alpha=0.5):
        ...
        self.ltm_optimizer = torch.optim.RMSprop(self.ltm_net.parameters(), lr=0.00025, eps=1e-6)
    ...
    def train_ltm_step(self):
        if self.first_ltm_train:
            ...
            loss_prev_task = torch.nn.functional.mse_loss(ltm_q_out_gen, prev_ltm_q_out_gen)
